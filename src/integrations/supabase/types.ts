...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      project_comparisons: {
        Row: {
          ...
          material_divergence: Json | null;
          measurement_divergence: Json | null;
          module_id_xml: string | null;
          reviewed_at: string | null;
          reviewed_by: string | null;
          sketchup_guid: string | null;
          status: string;
          thickness_divergence: Json | null;
          version_id: string;
        };
        Insert: {
          comments?: string | null;
        ...
        Relationships: [
          {
            foreignKeyName: "project_comparisons_company_id_fkey";
            columns: ["company_id"];
            isOneToOne: false;
            referencedRelation: "companies";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "project_comparisons_version_id_fkey";
            columns: ["version_id"];
            isOneToOne: false;
      ...
      project_tags: {
        ...
        Relationships: [
          {
            foreignKeyName: "project_tags_company_id_fkey";
            columns: ["company_id"];
            isOneToOne: false;
            referencedRelation: "companies";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "project_tags_version_id_fkey";
            columns: ["version_id"];
            isOneToOne: false;
            referencedRelation: "project_versions";
            referencedColumns: ["id"];
      ...
      validation_checks: {
        ...
        Relationships: [
          {
            foreignKeyName: "validation_checks_evidence_file_id_fkey";
    ...
    Enums: {
      app_role:
        "admin" | "escritorio" | "fabrica" | "montador" | "auditor" | "projetista" | "comercial";
      maintenance_status: "aberto" | "em_analise" | "producao" | "enviado" | "concluido";
      maintenance_type: "defeito" | "dano_transporte" | "erro_projeto" | "erro_montagem" | "outros";
      maintenance_urgency: "baixa" | "media" | "alta" | "critica";
      shipping_status: "aguardando" | "conferido" | "bloqueado" | "carregado" | "entregue";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
