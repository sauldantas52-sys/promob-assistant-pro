    ...
    parts.forEach(part => {
      ...
      for (let i = 0; i < repetition; i++) {
        ...
        physicalPieces.push({
          ...
          idXml: part.id_xml || '',
          parentIdXml: metadata.unique_parent_id || '',
          repetitionIndex: i,
          moduleSequence: metadata.module_sequence,
          pieceSequence: metadata.piece_sequence,
          ...
          edgeNameGeneral: metadata.edge_name_general,
          edgeNameFront: metadata.edge_name_front,
          metadata: metadata,
          lo,
          sh
        });
