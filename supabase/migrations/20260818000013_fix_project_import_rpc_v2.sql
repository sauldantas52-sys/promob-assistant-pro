-- Remover trigger se existir para evitar erros
DROP TRIGGER IF EXISTS tr_import_client_project_security ON public.projects;
...
BEGIN
    ...
    -- Ignorar verificação de project_import_sessions para este teste/bypass
