...
-- 2. Garantir que a coluna created_by existe na tabela projects (se faltar)
DO $$ 
BEGIN
...
-- 3. Criar função de bypass para o Piloto Controlado
-- Esta função permite inserir um projeto ignorando validações de estado se is_test = true
